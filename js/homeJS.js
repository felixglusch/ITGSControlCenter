var itgsApp = angular.module('itgsApp', []);
...
itgsApp.controller('homeController', ['$scope', '$log', 'cardCatQueryService', 'cardDataQueryService',
    function($scope, $log, cardCatQueryService, cardDataQueryService){
